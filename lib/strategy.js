 ...
 */
 ...
 //const getLong = (instagramappsecret,shortlivedaccesstoken) => fetch(`https://graph.instagram.com/access_token?grant_type=ig_exchange_token&client_secret=${instagramappsecret}&access_token=${shortlivedaccesstoken}`).then(res=>res.json())
...
Strategy.prototype.userProfile = function(accessToken, done) {
  ...
  this._oauth2.get('https://graph.instagram.com/me?fields=id,username&access_token='+ accessToken,accessToken, function (err, body, res) {
